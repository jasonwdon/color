...
import {wavelengthToColor, clearSandbox, removeById} from './utils.js';
...
function electromagnetic() {
  ...
  Button({id: 'mix-wavelengths-button', text: "mixing wavelengths?", x:125, y: 400, size: '20px', onClick: mixingWavelengths})
...
function mixingWavelengths() {
  ...
  interval = setInterval(drawMixingWavelengths.bind(null, ctx, rc), DELAY);
...
function drawMixingWavelengths(ctx, rc) {
  ...
  rc.rectangle(centerX(rect_width)+240-180, centerY(rect_height)-110, rect_width,rect_height, {fill:rgba1, fillStyle:'solid', roughness:2, seed:1});
  rc.rectangle(centerX(rect_width)+240+175, centerY(rect_height)-110, rect_width,rect_height, {fill:rgba2, fillStyle:'solid', roughness:2, seed:1});
